...
parser.add_argument('--kitti15_datapath', default='/home/kewei/ACVNet/data/KITTI_2015/', help='data path')
parser.add_argument('--kitti12_datapath', default='/home/kewei/ACVNet/data/KITTI_2012/', help='data path')
parser.add_argument('--testlist',default='./filenames/kitti15_test.txt', help='testing list')
...
# dataset, dataloader from main_kitti.py
# StereoDataset = __datasets__[args.dataset]
